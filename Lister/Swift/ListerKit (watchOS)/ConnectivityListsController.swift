...
public class ConnectivityListsController: NSObject, WCSessionDelegate {
    ...
    */
    ...
    private func processApplicationContext(applicationContext: [String: AnyObject]) {
        let lists: [[String: AnyObject]] = applicationContext[AppConfiguration.ApplicationActivityContext.currentListsKey] as! [[String: AnyObject]]  // FIXME: Pete, staticify dictionary keys across platforms
